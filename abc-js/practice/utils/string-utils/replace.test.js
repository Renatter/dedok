...
describe("replaceTests", () => {
  test("поменять вхождение текста", () => {
    ...
    assertToBe(
      replace("JS is great language", "JS", "Ts"),
      "Ts is great language"
    );
    assertToBe(
      replace("JS is great language", "great", "funny"),
      "JS is funny language"
    );
    assertToBe(
  ...
  test("не найденное вхождение, текст остался", () => {
    ...
    assertToBe(
      replace("JS is great language", "greet", "funny"),
      "JS is great language"
    );
  ...
  test("третий параметр должен быть только строкового типа", () => {
    assertThrow(
      () => replace("he ha", "ha"),
      "argument target must be type of string"
    );
    assertThrow(
      () => replace("he ha", "ha", 2),
      "argument target must be type of string"
  ...
  test("второй параметр должен быть только строкового типа", () => {
    assertThrow(
      () => replace("he ha"),
      "argument search must be type of string"
    );
    assertThrow(
      () => replace("he ha", undefined, "ha"),
      "argument search must be type of string"
    );
    assertThrow(
      () => replace("he ha", 2, "ha"),
  ...
  test("первый параметр должен быть только строкового типа", () => {
    ...
    assertThrow(
      () => replace(undefined, "u", "a"),
      "argument text must be type of string"
    );
    assertThrow(
      () => replace(25, "2", "5"),
      "argument text must be type of string"
...
describe("replaceAllTests", () => {
  test("поменять одно вхождение текста", () => {
    ...
    assertToBe(
      replaceAll("JS is great language", "JS", "Ts"),
      "Ts is great language"
    );
    assertToBe(
      replaceAll("JS is great language", "great", "funny"),
      "JS is funny language"
    );
    assertToBe(
  ...
  test("третий параметр должен быть только строкового типа", () => {
    ...
    assertThrow(
      () => replaceAll("he ha", "ha", 2),
      "argument target must be type of string"
    );
    assertThrow(
      () => replaceAll("he ha", "ha", ["hm"]),
      "argument target must be type of string"
    );
  });
  test("второй параметр должен быть только строкового типа", () => {
    ...
    assertThrow(
      () => replaceAll("he ha", undefined, "ha"),
      "argument search must be type of string"
    );
    assertThrow(
      () => replaceAll("he ha", 2, "ha"),
      "argument search must be type of string"
    );
  });
  test("первый параметр должен быть только строкового типа", () => {
